...
contract("Fundraiser", (accounts) => {
  ...
  describe("makeing donations", () => {
    const value = web3.utils.toWei('0.0289');
    const donor = accounts[2];
    it ("increases myDonationsCount", async () => {
        const currentDonationCount = await fundraiser.myDonationsCount(
          {from: donor}
        );
        ...
        assert.equal(
          1,
          newDonationsCount - currentDonationCount,
          "myDonationsCount should incrment by 1"
        );
    });
    ...
    it ("increases the totalDonations in amount", async () => {
    ...
    it ("increases donationsCount", async () => {
      ...
      assert.equal(
        ...
        "donationsCount should incrment by 1"
      );
    });
  ...
  describe("withdrawing fund", () => {
    ...
    it ("transfers balance to beneficiary", async () =>{
      ...
      assert.equal(
        ...
        "beneficiary should receive all the fund"
      );
    });
